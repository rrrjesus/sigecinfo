...
class Site extends Admin
{
    ...
    {
        parent::__construct();
//        var_dump((new Carousel())->find()->fetch(true));
    }
    ...
    public function home(?array $data): void
    {
        ...
        echo $this->view->render("widgets/site/home", [
            "app" => "site/home",
            "head" => $head
        ]);
    }
     ...
     * @param array|null $data
     */
    public function carousel(?array $data): void
    {

        $carousels = (new Carousel())->find()->fetch(true);

        $head = $this->seo->render(
            CONF_SITE_NAME . " | Carousel",
            CONF_SITE_DESC,
            url("/admin"),
            url("/admin/assets/images/image.jpg"),
            false
        ...
        echo $this->view->render("widgets/site/carousel", [
            "app" => "site/carousel",
            "head" => $head,
            "carousels" => $carousels
        ]);
     ...
     * @throws \Exception
     */
    public function carousels(?array $data): void
    {
        //MCE Upload
