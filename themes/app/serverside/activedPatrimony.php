...
products.product_name, users.user_name, users.login, users.phone_mobile, users.rf, users.email, units.unit_name, patrimonys.observations, patrimonys.file_terms
FROM patrimonys
