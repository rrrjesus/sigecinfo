...
products.product_name, users.user_name, users.login, users.rf, users.email, places.place_name, patrimonys.observations, patrimonys.file_terms
FROM patrimonys
LEFT JOIN products ON patrimonys.product_id = products.id
LEFT JOIN brands ON products.brand_id = brands.id
LEFT JOIN places ON patrimonys.place_id = places.id
