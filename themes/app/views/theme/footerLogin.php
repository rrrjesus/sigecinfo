        ...
        <div class="row">
            ...
            <div class="col-lg-2 mb-3">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2"><a data-bs-toggle-tooltip="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip-<?=color_month()?>" data-bs-title="Acessar Home"  class="text-decoration-none text-<?=color_month();?> fw-bold" href="<?= url(); ?>">Home</a></li>
                    <li class="mb-2"><a data-bs-toggle-tooltip="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip-<?=color_month()?>" data-bs-title="Acessar Contatos" class="text-decoration-none text-<?=color_month();?> fw-bold" href="<?= url("/contatos"); ?>">Contatos</a></li>
                    <li class="mb-2"><a data-bs-toggle-tooltip="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip-<?=color_month()?>" data-bs-title="Acessar Sobre" class="text-decoration-none text-<?=color_month();?> fw-bold" href="<?= url("/sobre"); ?>">Sobre</a></li>
<!--                    <li class="mb-2"><a data-bs-toggle-tooltip="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip-<?=color_month()?>" data-bs-title="Acessar Blog" class="text-decoration-none text-<?=color_month();?> fw-bold" href="http://10.23.237.79/blog">Blog</a></li>-->
                    <?php if(!empty($user->id)):?>
                        <li class="mb-2"><a data-bs-toggle-tooltip="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip-<?=color_month()?>" data-bs-title="Acessar Painel" class="text-decoration-none text-<?=color_month();?> fw-bold" href="<?= url("/dashboard"); ?>">Painel</a></li>
                    <?php else: ?>
                        <li class="mb-2"><a data-bs-toggle-tooltip="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip-<?=color_month()?>" data-bs-title="Login no Painel" class="text-decoration-none text-<?=color_month();?> fw-bold" href="<?= url("/entrar"); ?>">Entrar</a></li>
                    <?php endif;?>
                </ul>
            </div>
            ...
            <div class="col-lg-2">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2"><a target="_blank" class="text-decoration-none text-<?=color_month();?> fw-bold"
                                        href="https://www.facebook.com/<?= CONF_SOCIAL_FACEBOOK_PAGE; ?>" data-bs-toggle-tooltip="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip-<?=color_month()?>" data-bs-title="<?=CONF_SITE_NAME?> no Facebook"><i class="bi bi-facebook"></i> /SIGECINFO</a></li>
                    <li class="mb-2"><a target="_blank" class="text-decoration-none text-<?=color_month();?> fw-bold"
                                        href="https://www.instagram.com/<?= CONF_SOCIAL_INSTAGRAM_PAGE; ?>" data-bs-toggle-tooltip="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip-<?=color_month()?>" data-bs-title="<?=CONF_SITE_NAME?> no Instagram"><i class="bi bi-instagram"></i> @SIGECINFO</a></li>
                    <li class="mb-2"><a target="_blank" class="text-decoration-none text-<?=color_month();?> fw-bold" href="https://www.youtube.com/<?= CONF_SOCIAL_YOUTUBE_PAGE; ?>"
                                        data-bs-toggle-tooltip="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip-<?=color_month()?>" data-bs-title="<?=CONF_SITE_NAME?> no YouTube"><i class="bi bi-youtube"></i> /SIGECINFO</a></li>
                </ul>
            </div>
