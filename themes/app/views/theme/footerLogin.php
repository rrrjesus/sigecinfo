        ...
        <div class="row">
            <div class="col-lg-3 mb-3">
                <a data-bs-toggle-tooltip="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip-secondary"
                   data-bs-title="Agenda de Ramais" class="d-inline-flex align-items-center mb-2 text-body-emphasis text-decoration-none" href="<?=url("/contatos")?>" aria-label=Contatos">
                    <i class="bi bi-book fs-1 mb-3 me-2 text-secondary fw-bold"></i>
                    <span class="text-secondary fw-bold fs-6">SIGECINFO AGENDA</span>
                </a>
            ...
            <div class="col-lg-2 mb-3">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2"><a data-bs-toggle-tooltip="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip-secondary" data-bs-title="Acessar Home"  class="text-decoration-none text-secondary fw-bold" href="<?= url(); ?>">Home</a></li>
                    <li class="mb-2"><a data-bs-toggle-tooltip="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip-secondary" data-bs-title="Acessar Contatos" class="text-decoration-none text-secondary fw-bold" href="<?= url("/contatos"); ?>">Contatos</a></li>
                    <li class="mb-2"><a data-bs-toggle-tooltip="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip-secondary" data-bs-title="Acessar Sobre" class="text-decoration-none text-secondary fw-bold" href="<?= url("/sobre"); ?>">Sobre</a></li>
<!--                    <li class="mb-2"><a data-bs-toggle-tooltip="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip-secondary" data-bs-title="Acessar Blog" class="text-decoration-none text-secondary fw-bold" href="http://10.23.237.79/blog">Blog</a></li>-->
                    <?php if(!empty($user->id)):?>
                        <li class="mb-2"><a data-bs-toggle-tooltip="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip-secondary" data-bs-title="Acessar Painel" class="text-decoration-none text-secondary fw-bold" href="<?= url("/dashboard"); ?>">Painel</a></li>
                    <?php else: ?>
                        <li class="mb-2"><a data-bs-toggle-tooltip="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip-secondary" data-bs-title="Login no Painel" class="text-decoration-none text-secondary fw-bold" href="<?= url("/entrar"); ?>">Entrar</a></li>
                    <?php endif;?>
                </ul>
            </div>
            ...
            <div class="col-lg-2">
                <h5>Social:</h5>
                <ul class="list-unstyled">
                    <li class="mb-2"><a target="_blank" class="text-decoration-none text-secondary fw-bold"
                                        href="https://www.facebook.com/<?= CONF_SOCIAL_FACEBOOK_PAGE; ?>" data-bs-toggle-tooltip="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip-secondary" data-bs-title="<?=CONF_SITE_NAME?> no Facebook"><i class="bi bi-facebook"></i> /SIGECINFO</a></li>
                    <li class="mb-2"><a target="_blank" class="text-decoration-none text-secondary fw-bold"
                                        href="https://www.instagram.com/<?= CONF_SOCIAL_INSTAGRAM_PAGE; ?>" data-bs-toggle-tooltip="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip-secondary" data-bs-title="<?=CONF_SITE_NAME?> no Instagram"><i class="bi bi-instagram"></i> @SIGECINFO</a></li>
                    <li class="mb-2"><a target="_blank" class="text-decoration-none text-secondary fw-bold" href="https://www.youtube.com/<?= CONF_SOCIAL_YOUTUBE_PAGE; ?>"
                                        data-bs-toggle-tooltip="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip-secondary" data-bs-title="<?=CONF_SITE_NAME?> no YouTube"><i class="bi bi-youtube"></i> /SIGECINFO</a></li>
                </ul>
            </div>
