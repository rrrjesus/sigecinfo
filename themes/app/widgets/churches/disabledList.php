...
<div class="container-fluid">
    ...
    <div class="row justify-content-center mb-4">
        <div class="col-12 ml-auto text-center">
            <a data-bs-toggle-tooltip="tooltip" data-bs-placement="left" data-bs-custom-class="custom-tooltip-secondary"
        ...
        <div class="col-12">
            <table id="contacts" class="table table-bordered table-sm border-warning table-hover" style="width:100%">
                ...
                <?php foreach ($contacts as $lista): ?>
                    <tr>
                        <td class="text-center"><a href="../contatos/ativar/<?=$lista->id?>/actived" data-bs-toggle-tooltip="tooltip" 
                            data-bs-placement="top" data-bs-custom-class="custom-tooltip-secondary" data-bs-title="Clique para reativar <?=$lista->contact_name?>" role="button" 
