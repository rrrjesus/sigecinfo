...
<div class="container mt-4">
    ...
    <div class="row mb-4">
        <div class="col-md-8 col-lg-9 mb-3 mb-sm-0">
            <div class="card h-auto ">
                ...
                <div class="card-body">
                    ...
                    <?php if (in_array($user->level_id, [4, 5])): ?>
                        <a href="<?= url("/app/eventos/cadastrar"); ?>" class="btn btn-outline-secondary mt-2"><i class="bi bi-plus-circle me-2"></i> Adicionar Evento</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
