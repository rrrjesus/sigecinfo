...
<div class="px-4 py-5 my-5 text-center content">
    <i class="bi bi-ui-checks display-4"></i><h1>Siegcinfo</h1>
    ...
    <div class="col-lg-6 mx-auto">
        ...
        <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
            <?php if ($error->link): ?>
                <a class="btn btn-secondary btn-lg px-4 gap-3 text-light" role="button"
                   data-bs-toggle-tooltip="tooltip" data-bs-placement="bottom" data-bs-custom-class="custom-tooltip-secondary"
