...
<div class="pricing-header p-3 pb-md-4 mx-auto text-center">
    <p class="fs-2 fw-normal text-body-emphasis pb-0"><i class="bi bi-book-half text-secondary"></i> Agenda Inteligente SIGECINFO</p>
...
<style>
    .page-link {color: var(--bs-secondary);}
    .pagination {--bs-link-hover-color: var(--bs-secondary);}
    .page-item.active .page-link {color: #ffffff;background-color: var(--bs-secondary);border-color: var(--bs-secondary);}
</style>

<table id="contact" class="table table-hover table-bordered table-sm border-secondary p-2" style="width:100%">
    ...
    <tr>
        <td class="text-center fw-semibold" data-bs-toggle-tooltip="tooltip" data-bs-placement="left" data-bs-custom-class="custom-tooltip-secondary"
