...
<script src="<?=theme("/assets/js/email/FileSaver.min.js")?>"></script>
            ...
            <div class="pricing-header mx-auto text-center">
                <p class="fs-2 fw-normal text-body-emphasis"><i class="bi bi-credit-card-2-front me-2"></i> Gerador de Assinatura de E-mail SIGECINFO</p>
                <p class="fs-6 text-body-secondary pt-0">Gerador de assinatura de e-mail no padrão estabelecido no <strong>Manual de Identidade Visual da</strong>
                    <a class="text-decoration-none text-secondary fw-semibold" href="https://capital.sp.gov.br/documents/d/comunicacao/manual_de_identidade"
                    target="_blank">SECOM</a></p>
                <p class="fs-6 text-body-secondary pb-2">Em caso de dúvidas na utilização, acesse o
                    <a class="text-decoration-none text-secondary fw-semibold" href="<?=url("/themes/smsubweb/assets/manuais/manual_gerador_de_assinatura_smsub.pdf")?>"
            ...
            <form class="row gy-2 gx-3 align-items-center needs-validation" novalidate id="email" enctype="multipart/form-data">
                <div class="row justify-content-center mb-2">
                    ...
                    <div class="col-4">
                        ...
                        <input tabindex="1" autofocus data-bs-toggle-tooltip="tooltip" data-bs-placement="top" maxlength="50" data-bs-custom-class="custom-tooltip-secondary"
                                data-bs-title="Comece a digitar seu nome, caso não apareça na lista, digite manualmente" class="form-control form-control-sm border-secondary nomeinp" name="nomeinp" id="nomeinp" type="text" placeholder="DIGITE O NOME COMPLETO"/>
                    </div>

                    <div class="col-4">
                        <strong><label for="inputCargo" class="col-4 col-form-label col-form-label-sm">CARGO</label></strong>
                        <input tabindex="2" data-bs-toggle-tooltip="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip-secondary"
                                data-bs-title="Digite o cargo que você ocupa" class="form-control form-control-sm border-secondary cargoinp" type="text" maxlength="62" name="cargoinp" id="cargoinp" placeholder="DIGITE O CARGO"/>
                    </div>

                    <div class="col-4">
                        <strong><label for="inputSector" class="col-4 col-form-label col-form-label-sm">SETOR</label></strong>
                        <input tabindex="3" data-bs-toggle-tooltip="tooltip" data-bs-placement="top"
                                data-bs-custom-class="custom-tooltip-secondary"
                                data-bs-title="Digite o setor em que você trabalha"  class="form-control form-control-sm border-secondary sector" type="text" maxlength="54" id="sector" name="sector" placeholder="DIGITE O SETOR"/>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-4">
                        ...
                        <div class="input-group input-group-sm mb-3">
                            <input tabindex="4" type="text" aria-describedby="inputGroupPrepend" data-bs-toggle-tooltip="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip-secondary"
                                    data-bs-title="Preenchimento automático !!! Editável apenas se o e-mail não estiver preenchido !!!" class="form-control form-control-sm border-secondary emailinp" id="emailinp"
                    ...
                    <div class="col-4">
                        ...
                        <div class="input-group  input-group-sm mb-3">
                            <input tabindex="5" type="text" data-bs-toggle-tooltip="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip-secondary"
                                    data-bs-title="Apenas se tiver, digite os 4 dígitos do ramal de telefone" class="form-control form-control-sm border-secondary ramalinp" id="ramalinp"
                    ...
                    <div class="col-2">
                        ...
                        <div class="input-group input-group-sm mb-3">
                            <input tabindex="6" type="text" data-bs-toggle-tooltip="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip-secondary"
                                    data-bs-title="Apenas se tiver, digite apenas o número do andar" class="form-control form-control-sm border-secondary andarinp" maxlength="2" placeholder="10, 23 ou 24" name="andarinp">
                    ...
                    <div class="col-2">
                        ...
                        <div class="input-group  input-group-sm mb-3">
                            <input tabindex="7" type="text" data-bs-toggle-tooltip="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip-secondary"
                                    data-bs-title="Apenas se tiver, digite apenas o número e letra da sala" class="form-control form-control-sm border-secondary salainp" maxlength="4" placeholder="Nº e LETRA" name="salainp">
                ...
                <div class="row justify-content-center mb-2">
                    <div class="col-5">
                        <strong><label for="inputLogoTitle" class="col-4 col-form-label col-form-label-sm">SIGECINFO/SUBS</label></strong>
                        <input tabindex="8" data-bs-toggle-tooltip="tooltip" data-bs-placement="top" maxlength="50" data-bs-custom-class="custom-tooltip-secondary"
                                value="SIGECINFO" data-bs-title="Digite a Secretaria ou Subprefeitura" class="form-control form-control-sm border-secondary secsubinp" name="secsubinp" id="secsubinp" type="text" placeholder="DIGITE A SECRETARIA/SUBPREFEIRURA"/>
                    </div>

                    <div class="col-5">
                        <strong><label for="inputLogoTitle" class="col-4 col-form-label col-form-label-sm">ENDEREÇO</label></strong>
                        <input tabindex="9" data-bs-toggle-tooltip="tooltip" data-bs-placement="top" maxlength="64" data-bs-custom-class="custom-tooltip-secondary"
                                data-bs-title="Preenchimento automático !!! Mas pode ser editado !!!" class="form-control form-control-sm border-secondary enderecoinp" name="enderecoinp" id="enderecoinp" type="text"
                                value="R. José Buono, 65 - Jaçanã "placeholder="ENDEREÇO DA SECRETARIA/SUBPREFEIRURA"/>
                    </div>

                    <div class="col-2">
                        <strong><label for="inputCep" class="col-4 col-form-label col-form-label-sm">CEP</label></strong>
                        <input tabindex="10" data-bs-toggle-tooltip="tooltip" data-bs-placement="top" maxlength="9" data-bs-custom-class="custom-tooltip-secondary"
                                value="02273-120" data-bs-title="Preenchimento automático !!! Mas pode ser editado !!!" class="form-control form-control-sm border-secondary cepinp" name="cepinp" id="cepinp" type="text" placeholder="00000-000"/>
                    </div>
                </div>
                ...
                <div class="row justify-content-center mt-3 mb-3">
                    <div class="col-auto">
                        <button tabindex="11" id="gerarpng" data-bs-toggle-tooltip="tooltip" data-bs-placement="bottom"
                                data-bs-custom-class="custom-tooltip-secondary"
                        ...
                        <a href="<?=url("/email")?>" tabindex="12" data-bs-toggle-tooltip="tooltip" data-bs-placement="bottom" role="button" data-bs-custom-class="custom-tooltip-secondary"
            ...
            <script>
                ...
                let secsubinp = new Bloodhound({
                    datumTokenizer: Bloodhound.tokenizers.whitespace, queryTokenizer: Bloodhound.tokenizers.whitespace,
                    local: <?=(new \Source\Models\Company\Place())->completeName("place_name")?>
                });
