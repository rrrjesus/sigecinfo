...
<div class="form-signin w-100 m-auto mt-5 p-5">
    ...
    <form class="needs-validation" novalidate id="forget" action="<?=url("/recuperar")?>" method="post" enctype="multipart/form-data">
        ...
        <p class="text-center fw-semibold text-gray-700">Informe seu e-mail para receber um link de recuperação de senha.</p>
        ...
        <button class="btn btn-secondary w-100 py-2 fw-semibold mt-3" type="submit" data-bs-toggle-tooltip="tooltip" data-bs-placement="right"  data-bs-title="Clique para recuperar a sua senha !!!" data-bs-custom-class="custom-tooltip-secondary">Recuperar Senha</button>
    </form>
