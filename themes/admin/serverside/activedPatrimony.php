...
$columns = array(
    ...
    array( 'db' => 'id', 'dt' => 14,
        'formatter' => function($d) {
            return '<a href="../beta/patrimonio/termo/'.$d.'" role="button" aria-disabled="true" data-bs-toggle-tooltip="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip-secondary"
