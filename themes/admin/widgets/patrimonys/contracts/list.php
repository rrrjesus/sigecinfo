    ...
    <div class="row justify-content-center mb-4">
        <div class="col-12 ml-auto text-center">
            <a data-bs-toggle-tooltip="tooltip" data-bs-placement="left" data-bs-custom-class="custom-tooltip-<?=color_month()?>"
                ...
                <a role="button" href="<?=url("/painel/patrimonio/contratos/desativados")?>" data-bs-toggle-tooltip="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip-<?=color_month()?>"
    ...
    <div class="d-flex justify-content-center">
        <div class="col-12">
            <table id="contracts" class="table table-bordered table-sm border-secondary table-hover" style="width:100%">
                ...
                <tr>
                    <td class="text-center fw-semibold"><a href="<?= url("/painel/patrimonio/contratos/editar/{$lista->id}"); ?>" role="button" aria-disabled="true" data-bs-toggle-tooltip="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip-<?=color_month()?>"
