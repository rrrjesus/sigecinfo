...
<div class="container-fluid">
    ...
    <div class="row justify-content-center mb-4">
        <div class="col-12 ml-auto text-center">
            <a data-bs-togglee="tooltip" data-bs-placement="left" data-bs-custom-class="custom-tooltip-<?=color_month()?>"
                ...
                <a role="button" href="<?=url("/painel/patrimonio/tipos-de-produtos/desativados")?>" data-bs-togglee="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip-<?=color_month()?>"
    ...
    <div class="d-flex justify-content-center">
        <div class="col-12">
            <table id="productTypes" class="table table-bordered table-sm border-secondary table-hover" style="width:100%">
                ...
                <tr>
                    <td class="text-center fw-semibold"><a href="<?= url("/painel/patrimonio/tipos-de-produtos/editar/{$lista->id}"); ?>" role="button" aria-disabled="true" data-bs-togglee="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip-<?=color_month()?>"
                                ...
                                <div class="modal-dialog modal-sm modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body fs-5 text-center">
                                            Deseja desativar o tipo de produto <?=$lista->type_name?> ?
                                        </div>
                                        <div class="modal-footer justify-content-center">
                                            ...
                                            <a href="tipos-de-produtos/desativar/<?=$lista->id?>/disabled" role="button" class="btn btn-sm btn-outline-success fw-semibold"><i class="bi bi-check2-circle me-2"></i>Sim</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
