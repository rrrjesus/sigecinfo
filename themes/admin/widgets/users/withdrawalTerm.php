...
<div class=WordSection1>
	...
	<div align=center>
		...
		portador do Registro Funcional (RF) <span><b><?=$term->user()->rf?></span></b>, lotado/a na <span><b><?=$term->user()->church()->church_name?></b></span>,
		...
		font-family:"Arial",sans-serif;font-weight:normal'> de imediato, comunicando por e-mail : <b>informatica.setor11@gmail.com</b> ou <b>memorando</b>, 
		...
		10.0pt;font-family:"Arial",sans-serif'><?=(!empty($term->user()->phone_mobile) ? '('.substr($term->user()->phone_mobile, 0,2).')'.substr($term->user()->phone_mobile, 2,9) : "_____________________________");?></span></p>
