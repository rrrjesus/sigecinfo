        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <?= button(["href" => url()."/painel/tipos-de-eventos/cadastrar", "title" => "Cadastrar novo tipo do evento", "custom" => "custom-tooltip-secondary","name" => "Cadastrar", "icon" => "plus-circle me-1", "btncolor" => "primary"]); ?>
                        <?php if (!empty($registers->disabled)) : ?>
                            <?= button(["href" => url()."/painel/tipos-de-eventos/desativados", "title" => "Tipos de eventos desativados", "custom" => "custom-tooltip-secondary", "name" => "Eventos Inativos", "icon" => "calendar-plus me-1", "btncolor" => "light", "disabled_count" => $registers->disabled]); ?>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="card-body">
