        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header bg-<?=CONF_APP_COLOR?> text-white d-flex justify-content-between align-items-center fw-semibold">
                    ...
                    <div>
                        <?= button(["href" => url("/app/eventos"), "name" => "Voltar para Eventos", "icon" => "calendar", "btncolor" => "secondary", "title" => "Voltar para a lista de eventos ativos", "custom" => "custom-tooltip-secondary"]); ?>
                    </div>
                </div>
                <div class="card-body">
