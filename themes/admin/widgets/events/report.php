...
<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
    <li class="nav-item" role="presentation">
        <a href="<?= url("/painel/eventos/editar/{$event->id}"); ?>" class="nav-link link-body-emphasis">Edição</a>
    </li>
    <li class="nav-item" role="presentation">
                                    ...
                                    <td class="text-center">
                                     ...
                                     <td class="text-center">
                                            <?php if ($participant && $participant->status !== 'convocado'): ?>
                                                <form class="ajax_off" style="display: inline;" action="<?= url("/painel/eventos/alterar-resposta"); ?>" method="post">
                                                    <?= csrf_input(); ?>
