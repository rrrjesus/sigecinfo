...
<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
    ...
    <li class="nav-item" role="presentation">
        <a href="<?= url("/painel/eventos/portaria/{$event->id}"); ?>" class="nav-link link-body-emphasis fw-semibold">Relatórios e Portaria</a>
    </li>
</ul>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-12">
                ...
                <?php endif; ?>
                        ...
                        <!-- Event Info Card -->
                        <div class="card mb-2">
                            <div class="card-header fw-semibold"><i class="bi bi-calendar-event me-1"></i> Informações do Evento</div>
                            <div class="card-body">
                                <div class="row">
                        ...
                        <div class="card mb-2">
                            <div class="card-header fw-semibold"><i class="bi bi-people-fill me-1"></i> Convocação de Participantes</div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                        ...
                        <div class="card mb-2">
                            <div class="card-header fw-semibold"><i class="bi bi-geo-alt me-1"></i> Data e Local</div>
                            <div class="card-body">
                                <div class="row align-items-end">
                                    ...
                                    <?php endif; ?>
                                    <div class="col-md-6 mb-1">
                                        <label class="col-form-label col-form-label-sm" for="place_id"><strong>Local </strong> (Opcional)</label>
                                        <select id="place_id" name="place_id" class="form-select form-select-sm">
                                            <option value="">Selecione um local...</option>
                                            <?php if (!empty($places)): foreach ($places as $place): ?>
                                                <option value="<?= $place->id; ?>" <?= !empty($event) && $event->place_id == $place->id ? 'selected' : ''; ?>><?= $place->place_name; ?></option>
                                            <?php endforeach; endif; ?>
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-1">
                            ...
                            <div class="card-footer text-center">
                                <?php if (!empty($canStart)): ?>
                                    <?= button(["href" => url()."/painel/eventos/iniciar/{$event->id}", "name" => "Iniciar", "icon" => "play-circle me-1", "btncolor" => "success"]); ?>
                                <?php endif; ?>
