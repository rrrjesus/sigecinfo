        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <?= button(["href" => "/painel/eventos/cadastrar", "name" => "Cadastrar Eventos", "icon" => "calendar-plus me-1", "class" => "m-2"]); ?>
                        <?php if (!empty($registers->disabled)) : ?>
                            <?= button(["href" => "/painel/eventos/desativados", "name" => "Eventos Inativos", "icon" => "calendar-plus me-1", "btncolor" => "secondary", "disabled_count" => $registers->disabled]); ?>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="card-body">
