    ...
    <nav class="sb-sidenav accordion bg-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            ...
            <div class="nav">
                    ...
                    <div class="collapse" id="collapseEvents" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionEvents">
                            ...
                            <div class="collapse" id="eventsSub" data-bs-parent="#sidenavAccordionEvents">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <?php if (Auth::check('events_create')): ?>
                                        <a class="nav-link" href="<?=url("/painel/eventos/cadastrar")?>" data-bs-toggle-tooltip="tooltip" data-bs-custom-class="custom-tooltip-dark" data-bs-placement="right" title="Cadastrar um novo evento"><i class="bi bi-plus-circle me-2"></i> Cadastrar</a>
                                    <?php endif; ?>
                                    <?php if (Auth::check('events_view')): ?>
                                        <a class="nav-link" href="<?=url("/painel/eventos")?>" data-bs-toggle-tooltip="tooltip" data-bs-custom-class="custom-tooltip-dark" data-bs-placement="right" title="Listar um novo evento"><i class="bi bi-list me-2"></i> Listar Todos</a>
                                    <?php endif; ?>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="typesSub" data-bs-parent="#sidenavAccordionEvents">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <?php if (Auth::check('event_types_create')): ?>
                                        <a class="nav-link" href="<?=url("/painel/tipos-de-eventos/cadastrar")?>" data-bs-toggle-tooltip="tooltip" data-bs-custom-class="custom-tooltip-dark" data-bs-placement="right" title="Cadastrar um novo evento"><i class="bi bi-plus-circle me-2"></i> Cadastrar</a>
                                    <?php endif; ?>
                                    <?php if (Auth::check('event_types_view')): ?>
                                        <a class="nav-link" href="<?=url("/painel/tipos-de-eventos")?>" data-bs-toggle-tooltip="tooltip" data-bs-custom-class="custom-tooltip-dark" data-bs-placement="right" title="Listar um novo tipo de evento"><i class="bi bi-list me-2"></i> Listar</a>
                                    <?php endif; ?>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="placesSub" data-bs-parent="#sidenavAccordionEvents">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <?php if (Auth::check('places_create')): ?>
                                        <a class="nav-link" href="<?=url("/painel/locais/cadastrar")?>" data-bs-toggle-tooltip="tooltip" data-bs-custom-class="custom-tooltip-dark" data-bs-placement="right" title="Cadastrar um novo local"><i class="bi bi-plus-circle me-2"></i> Cadastrar</a>
                                    <?php endif; ?>
                                    <?php if (Auth::check('places_view')): ?>
                                        <a class="nav-link" href="<?=url("/painel/locais")?>" data-bs-toggle-tooltip="tooltip" data-bs-custom-class="custom-tooltip-dark" data-bs-placement="right" title="Listar um novo local"><i class="bi bi-list me-2"></i> Listar</a>
                                    <?php endif; ?>
                                </nav>
                            </div>
                        </nav>
                ...
                <?php if (Auth::canAccessModule('users')): ?>
                    ...
                    <div class="collapse" id="collapseUsers" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionUsers">
                                ...
                                <div class="collapse" id="collapseUser" data-bs-parent="#sidenavAccordionUsers">
                                    ...
                                    <nav class="sb-sidenav-menu-nested nav">
                                        <?php if (Auth::check('users_create')): ?>
                                            <a class="nav-link" href="<?=url("/painel/usuarios/cadastrar")?>" data-bs-toggle-tooltip="tooltip" data-bs-custom-class="custom-tooltip-dark" data-bs-placement="right" title="Cadastrar um novo usuario"><i class="bi bi-plus-circle me-2"></i> Cadastrar</a>
                                        <?php endif; ?>
                                        <?php if (Auth::check('users_view')): ?>
                                            <a class="nav-link" href="<?=url("/painel/usuarios")?>" data-bs-toggle-tooltip="tooltip" data-bs-custom-class="custom-tooltip-dark" data-bs-placement="right" title="Listar um novo local"><i class="bi bi-list me-2"></i> Listar</a>
                                        <?php endif; ?>
                                    </nav>
                                </div>
                ...
                <?php if (\Source\Domain\Shared\Models\Auth::canAccessModule('acl')): ?>
                    <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseAcl" aria-expanded="false" aria-controls="collapseAcl">
                        <div class="sb-nav-link-icon"><i class="bi bi-shield-lock bi-2xx"></i></div>
                        Controle de Acesso
                        <div class="sb-sidenav-collapse-arrow"><i class="bi bi-chevron-double-down"></i></div>
                    </a>
                    <div class="collapse" id="collapseAcl" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionAcl">
